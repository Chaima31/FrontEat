...
import { Table, Form, Button, Modal, Navbar } from "react-bootstrap";
...
function Zones() {
  ...
  const fetchCities = async () => {
    try {
      const response = await axiosInstance.get("http://localhost:8080/api/zone");
        ...
        <div >
          <div className="container mb-4">
            ...
            <Form onSubmit={handleAddZone}>
              ...
              <Button className="btn btn-danger mt-2 mb-2" type="submit">
                Add 
              </Button>
            </Form>
          </div>
